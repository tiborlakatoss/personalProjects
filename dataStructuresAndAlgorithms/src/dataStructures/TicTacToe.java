...
//* The computer is able to play intelligently and block the user and try to win

//* It uses a 2D array to create a grid for the game
//* The user makes their moves using a coordinate system//for the Scanner
